...
namespace SogetiSkills.Core.Managers
{
    ...
    public interface ISearchManager
    {
        ...
        Task<IEnumerable<ConsultantWithSkills>> SearchConsultantsAsync(bool? beachStatus, string lastName, string emailAddress, IEnumerable<string> skills, SkillSearchType skillSearchType);
    }
}
